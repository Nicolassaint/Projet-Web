...
<nav class="navbar navbar-expand-lg">
    ...
    <h2 style ="text-align : center;">Département de Physique</h2>

    <div class="container infos">
            <img src="physique.png" width="300" height="200">
    </div>
...
if ($db_found) {
    ...
    $sql = "SELECT nom FROM professeur WHERE departement like '%Physique%'";
    ...
    echo "<div class =section> <p>Liste des professeurs : </p> <br></div>";
        ...
        while ($data = mysqli_fetch_assoc($result)) {
            ...
            echo "<br>";
            echo '<span><a href="crambes.php?nom='. $data['nom'].'">details view</a><span><br>';
            echo'</div>';

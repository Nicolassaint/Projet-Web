...
<nav class="navbar navbar-expand-lg">
    ...
    <h2 style ="text-align : center;">Laboratoire systèmes intelligents communicants</h2>

    <div class="container infos">
            <img src="SIC.png" width="250" height="200">
    </div>;
...
if ($db_found) {
    ...
    $sql = "SELECT nom FROM professeur WHERE profession like '%chercheur%' and laboratoire like '%Intelligents%'";
